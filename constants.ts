...
export const STORE_CATEGORIES: Record<StoreType, string[]> = {
  ...
  'Restaurant': ['North Indian', 'South Indian', 'Chinese', 'Fast Food', 'Biryani', 'Beverages', 'Desserts']
};
...
export const MOCK_STORES: Store[] = [
  ...
  { id: 'store-10', ownerId: 'owner-10', name: 'Green Harvest Agro', type: 'Agriculture', address: 'Kisan Mandi, Indore', phoneNumber: '+91 98765 43219' },
  { id: 'store-11', ownerId: 'owner-11', name: 'The Royal Tandoor', type: 'Restaurant', address: 'Food Street, Indore', phoneNumber: '+91 98765 43220' },
  { id: 'store-12', ownerId: 'owner-12', name: 'Gadget Galaxy', type: 'Electronics', address: 'MG Road, Indore', phoneNumber: '+91 98765 43221' },
  { id: 'store-13', ownerId: 'owner-13', name: 'Spice Route', type: 'Restaurant', address: 'Vijay Nagar, Indore', phoneNumber: '+91 98765 43222' }
];
...
export const MOCK_PRODUCTS: Product[] = [
  ...
  // NEW PRODUCTS
  {
    ...
    description: 'High-yield hybrid tomato seeds suitable for home gardening and farming.',
    price: 450.00,
    storeType: 'Agriculture',
    category: 'Seeds',
    imageUrl: 'https://images.unsplash.com/photo-1592841200221-a6898f307baa?auto=format&fit=crop&w=800&q=80',
    stock: 50,
    storeName: 'Green Harvest Agro',
    storeId: 'store-10',
    distance: '3.0 mi'
  },
  {
    ...
    description: 'Nutrient-rich organic fertilizer to boost plant growth.',
    price: 300.00,
    storeType: 'Agriculture',
  ...
  },
  {
    ...
    description: 'Ultra HD 4K Smart TV with Dolby Audio and built-in apps.',
    price: 42999.00,
    storeType: 'Electronics',
    category: 'Appliances',
